...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pymmcore-plus-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15403&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pymmcore-plus-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pymmcore-plus` can be installed with:

```
conda install pymmcore-plus
```

It is possible to list all of the versions of `pymmcore-plus` available on your platform with:
